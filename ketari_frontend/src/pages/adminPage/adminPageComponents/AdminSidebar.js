...
export default function AdminSidebar() {
  ...
  return (
    <>
      <div className="flex flex-col justify-between bg-[#022339] md:w-full w-[75%]">
        <div className="px-4 py-6">
          <nav className="mt-6 flex flex-col space-y-1">
            <NavLink
              ...
              className={(props) => {
                return `${
                  ...
                  "bg-gray-300"
                } flex items-center md:text-sm text-xs md:font-medium rounded-lg hover:bg-gray-100 hover:text-gray-700 px-4 py-2 text-[#fff]`;
              }}
            >
              <svg
            ...
            <details className="group">
              <summary className="flex cursor-pointer items-center rounded-lg px-4 py-2 text-[#fff] hover:bg-gray-100 hover:text-gray-700">
              ...
              <nav className="mt-1.5 ml-8 flex flex-col">
                <NavLink
                  ...
                  className={(props) => {
                    return `${
                      props.isActive && "bg-gray-300"
                    } flex items-center md:text-sm text-xs md:font-medium rounded-lg hover:bg-gray-100 px-4 py-2 text-[#fff]`;
                  }}
                >
            ...
            <details className="group">
              ...
              <nav className="mt-1.5 ml-8 flex flex-col">
                ...
                <button
                  ...
                  className="flex w-full items-center rounded-lg px-4 py-2 text-[#fff] hover:bg-gray-100 hover:text-gray-700"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 opacity-75"
