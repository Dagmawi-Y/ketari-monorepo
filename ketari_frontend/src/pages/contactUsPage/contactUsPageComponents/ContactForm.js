  ...
  return (
    <section className="py-16 container mx-auto px-5">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 shadow-lg py-8 px-5">
        <div>
          <h2 className="font-bold mb-4 text-xl text-accent">CONTACT US</h2>
          <div className="flex justify-center items-center">
            <form>
              ...
              <input
                type="submit"
                value="SEND MESSAGE"
                className="btn bg-[#fdb82c] hover:bg-white duration-700 text-white hover:text-primary border-[#fdb82c] border-2 hover:border-primary font-bold rounded-none w-full max-w-xs mt-2"
              />
            </form>
          </div>
        </div>
