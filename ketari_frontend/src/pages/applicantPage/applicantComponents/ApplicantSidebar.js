    ...
    <>
      <ul className="menu p-4 overflow-y-auto w-60 bg-[#022339] text-base-content">
        ...
        <li>
          <Link
            to="applied-jobs"
            className="flex items-center my-1 px-4 py-3 text-[#c7ced3] font-bold border-l-4 border-transparent hover:border-secondary hover:text-white hover:bg-gray-300 transition"
          >
