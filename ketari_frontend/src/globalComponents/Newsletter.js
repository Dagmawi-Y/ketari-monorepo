...
const Newsletter = () => {
  ...
  return (
    <section className="bg-[#f2f5fb] p-10 max-w-4xl mx-auto py-16 px-5">
      <div className="flex justify-center">
        <div>
          <div>
            <h2 className="text-3xl font-bold text-[#452525] mb-4">
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex">
              ...
              <button
                disabled={isLoading}
                type="submit"
                className="bg-[#fdb82c] hover:bg-transparent text-white border-[#fdb82c] hover:border-primary hover:text-primary font-bold px-2 md:px-10 duration-700 border-2  "
              >
                {isLoading ? (
                  <Dna
                    visible={true}
