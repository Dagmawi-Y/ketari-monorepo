          ...
          <div className="card text-neutral-content">
            <div className="card-body items-center text-center">
              ...
              <div className="card-actions justify-center my-2">
                <Link
                  to="/register"
                  className="btn rounded-none duration-700 flex px-4 md:px-7 py-3 bg-[#fdb82c] hover:bg-transparent text-white border-[#fdb82c] hover:border-primary hover:text-primary font-bold border-2 hover:border-2"
                >
                  <MdOutlineAppRegistration size={22} className="mr-1" /> Sign
                  Up Now
                </Link>
              </div>
            </div>
          ...
          <div className="card text-neutral-content">
            <div className="card-body items-center text-center">
              ...
              <div className="card-actions justify-center my-2">
                <Link
                  to="/jobs"
                  className="btn rounded-none flex duration-700 px-4 md:px-7 py-3 bg-[#fdb82c] hover:bg-transparent text-white border-[#fdb82c] hover:border-primary hover:text-primary font-bold border-2 hover:border-2"
                >
          ...
          <div className="card text-neutral-content">
            <div className="card-body items-center text-center">
              ...
              <div className="card-actions justify-center my-2">
                <Link
                  to="/jobs"
                  className="btn rounded-none flex px-4 md:px-7 duration-700 py-3 bg-[#fdb82c] hover:bg-transparent text-white border-[#fdb82c] hover:border-primary hover:text-primary font-bold border-2 hover:border-2"
                >
